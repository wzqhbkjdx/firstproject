...
import com.agile.news.bean.FunctionList.FunctionItem;
...
public class GsonTools {
	...
	public static String creatGsonString(Object object) {
		Gson gson = new Gson();
	...
	public static List<FunctionItem> changeGsonToFunList(String gsonString, Class<FunctionItem> cls) {
		Gson gson = new Gson();
		List<FunctionItem> list = gson.fromJson(gsonString, new TypeToken<List<FunctionItem>>() {}.getType());
		return list;
	}
