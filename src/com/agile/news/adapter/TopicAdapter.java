...
public class TopicAdapter extends BaseAdapter{
	...
	public TopicAdapter(Context context, ArrayList<Topic> datas, String countCommentUrl) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(TextUtils.isEmpty(topic.listmage)) {
			...
			case 1:
				...
				if(type == 1) {
					...
					bitmapUtils.display(holder.topic_iv, topic.listmage);
				} else {
